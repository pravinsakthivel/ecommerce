...
Empty Cart - If cart is empty , Explore Items Button will be displayed , whicg takes user to product catalog
...
```
If Product catalog Page is accessed less than a minute for previous load , data will be returned from cache/existing state
