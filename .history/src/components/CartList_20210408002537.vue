  ...
  <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-horizontal">
            ...
            <div class="card-body">
              ...
              <p>
                <strong>
                  Price : $ <span v-text="item.cartValue ? item.cartValue : item.price"></span
                ></strong>
              </p>
    ...
    <div v-else>
      ...
      <div class="text-center">
        <base-button @click-action = "loadPaymentOption">Checkout</base-button>
        <base-button @click-action="goToProducts">Go Back</base-button>
      </div>
    </div>
  </div>
</template>
