<template>
  <div class="container-fluid">
    ...
    <div v-if="cartItems.length < 1" class="text-center row">
    ...
    <base-button link toPage="/checkout"><base-button>
    <!-- <form class="text-center" v-else>
...
export default {
  components: { PaymentDetails, BaseButton },
  data() {
    return {
      quantity: 1,
    };
