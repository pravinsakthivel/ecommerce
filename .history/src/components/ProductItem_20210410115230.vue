  ...
  >
    <div class="card h-100 ">
      <div class="card-body">
        ...
        >
        <base-modal customClass="ml-2" primaryButton="Okay">
          <template #baseButton>Details</template>
          <template #title> {{product.productId}} </template>
          <template #body>{{product.productDesc}}</template>
          <template v-slot:secondaryButton>Cancel</template>
          <template v-slot:primaryButton>Okay</template>
        </base-modal>
      </div>
    </div>
  </div>
