        ...
        <div class="card">
          <div class="card-horizontal">
            ...
            <div class="card-body">
              ...
              <input type="number" class="form-control ml-2" v-model="quantity" @change="setTotalCartvalue(quantity,price)">
              </form>
             
              <p><strong> Price : $ <span v-text="itemPrice(item.price)"></span></strong></p>
...
export default {
  ...
  methods: {
    ...
    setTotalCartvalue(quantity,price){
      this.totalCartvalue += quantity * price;
    }
  },
};
</script>
