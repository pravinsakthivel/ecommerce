<template>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#baseModal" id="modal">
  Remove Item
</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" @click="removeProductItem">
...
export default {
  ...
  methods:{
    removeProductItem(productItem){
      this.$emit('remove-item',productItem);
    }
  }
